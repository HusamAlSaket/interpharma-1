...
const Hero = () => {
  return (
    <section id="hero" className="relative min-h-screen w-full flex items-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-white text-center px-6 py-16">
        <span className="inline-block px-4 py-1 bg-orange-500/20 text-orange-400 rounded-full text-sm font-semibold mb-6 border border-orange-500/30">
        ...
        <p className="mt-8 text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
          InterPharma One is committed to advancing pharmaceutical research and providing cutting-edge healthcare solutions. 
          Our team is dedicated to improving the quality of life through science and innovation.
        </p>
        
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/services" className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-lg shadow-lg transition-all duration-300 font-medium flex items-center group">
          ...
          <Link href="/about-us" className="border border-white/30 hover:border-white/60 text-white px-8 py-3 rounded-lg shadow-lg hover:bg-white/10 transition-all duration-300">
            About Us
          </Link>
        </div>
